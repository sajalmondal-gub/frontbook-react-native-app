...
import { View, Text, TouchableOpacity, Dimensions, Image, StyleSheet, BackHandler, Modal } from 'react-native';
...
export default function DrawerMenu() {
  ...
  return (
    <Modal visible={isVisible} transparent={true} animationType="none" statusBarTranslucent>
